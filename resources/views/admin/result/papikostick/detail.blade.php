                            ...
                            <table class="table table-sm table-hover table-bordered">
                                ...
                                @foreach($huruf as $key=>$h)
                                    <tr>
                                        <td>{{ $key+1 }}.</td>
                                        <td>{{ $h }}</td>
                                        <td>{{ $result->hasil[$h] }}</td>
                                        <td style="text-align: left">{{ analisisPapikostick($result->hasil[$h], $keterangan->keterangan[$h]) }}</td>
                                        @php array_push($data, array('letter' => $h, 'number' => $result->hasil[$h])); @endphp
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
