            ...
            <div class="col-lg-8 order-2 order-lg-1">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <input name="foto_ijazah" type="hidden" class="form-control {{ $errors->has('file_foto_ijazah') ? 'is-invalid' : '' }}" value="{{ !empty($array) ? $array['foto_ijazah'] : old('foto_ijazah') }}">
                        <button class="btn d-grid w-100 {{ $errors->has('file_foto_ijazah') ? 'btn-outline-danger' : 'btn-outline-primary' }} btn-upload" data-id="foto_ijazah" type="button"><i class="bi bi-upload"></i>Upload Foto Ijazah</button>
